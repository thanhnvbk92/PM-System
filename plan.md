...
- [ ] Khởi tạo cấu trúc thư mục dự án (Backend, Client, Web)
- [ ] Thiết lập Database (ClickHouse/TimescaleDB)

### Giai đoạn 2: Phát triển Backend
- [ ] Xây dựng API tiếp nhận dữ liệu (FastAPI)
- [ ] Xây dựng logic xử lý và lưu trữ dữ liệu
- [ ] Xây dựng API phục vụ Dashboard (REST/WebSockets)
...
- [ ] Thiết lập Docker để triển khai
